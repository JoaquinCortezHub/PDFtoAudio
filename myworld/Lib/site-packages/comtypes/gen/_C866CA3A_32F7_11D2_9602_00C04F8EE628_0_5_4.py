...
__all__ = [
    'SRADynamic', 'DISPID_SVSInputWordLength', 'DISPID_SVEWord',
    'SpInProcRecoContext', 'DISPIDSPTSI', 'DISPID_SGRSTText',
    'ISpeechMMSysAudio', 'SpeechPropertyComplexResponseSpeed',
    'SPXMLRESULTOPTIONS', 'DISPID_SPEDisplayAttributes',
    'SPCS_ENABLED', 'SVP_9', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRGSetTextSelection', 'SVP_6',
    'SpeechRegistryLocalMachineRoot', 'SPCT_COMMAND',
    'SAFTExtendedAudioFormat', 'SpeechEngineProperties',
    'SSSPTRelativeToCurrentPosition', 'SPEI_MAX_TTS',
    'SPPHRASEELEMENT', 'SPSEMANTICERRORINFO', 'SVPAlert',
    'SVSFNLPSpeakPunc', 'DISPID_SPARecoResult',
    'DISPID_SpeechFileStream', 'DISPID_SRRTStreamTime',
    'SGRSTTWildcard', 'DISPID_SpeechGrammarRule', 'SVEAllEvents',
    'SAFT8kHz16BitMono', 'SVP_13', 'SPPS_NotOverriden',
    'SSTTTextBuffer', 'eLEXTYPE_PRIVATE8', 'DISPID_SRCEAudioLevel',
    'DISPID_SVEPhoneme', 'DISPID_SPPs_NewEnum', 'ISpRecoCategory',
    'SPEI_TTS_PRIVATE', 'SpeechPropertyNormalConfidenceThreshold',
    'SSSPTRelativeToStart', 'DISPID_SOTCGetDataKey',
    'SVSFParseAutodetect', 'SAFTADPCM_44kHzStereo', 'SPLEXICONTYPE',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechPhraseReplacements', 'ISpeechGrammarRule',
    'DISPID_SPPsItem', 'DISPID_SPERetainedSizeBytes', 'SINoise',
    'SREAudioLevel', 'ISpRecoResult', 'DISPID_SRProfile',
    'SPEI_VISEME', 'SpPhoneticAlphabetConverter', 'DISPID_SRGId',
    'DISPIDSPTSI_SelectionLength', 'ISpRecoGrammar', 'SPWF_SRENGINE',
    'DISPID_SPIAudioSizeTime', 'eLEXTYPE_PRIVATE10',
    'ISpeechRecoResult2', 'DISPID_SLPPartOfSpeech',
    'DISPID_SLPs_NewEnum', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SRRTTickCount', 'SVP_3',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SBSRead', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPRuleConfidence', 'SPAUDIOSTATUS', 'SpeechFormatType',
    'SASStop', 'IInternetSecurityManager', 'SVP_0',
    'ISpObjectTokenCategory', 'SPRULE', 'ISpeechXMLRecoResult',
    'SpShortcut', 'DISPID_SPIProperties', 'DISPID_SMSGetData',
    'DISPID_SVGetAudioOutputs', 'SpSharedRecoContext',
    'SAFT11kHz16BitMono', 'SVEAudioLevel', 'SVP_4',
    'DISPID_SPRuleNumberOfElements', 'eLEXTYPE_VENDORLEXICON',
    'ISpSerializeState', 'SREInterference', 'SPADAPTATIONRELEVANCE',
    'DISPID_SGRSTsCount', 'SpeechGrammarState',
    'SPINTERFERENCE_NOSIGNAL', 'ISpShortcut', 'SVP_5',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_11', 'SPSHT_OTHER',
    'DISPID_SPPId', 'ISpeechPhraseAlternate', 'DISPID_SFSOpen',
    'DISPID_SPEAudioSizeTime', 'SpeechWordType', 'DISPID_SPRuleName',
    'DISPID_SRCBookmark', 'SP_VISEME_14', 'SpUnCompressedLexicon',
    'ISpeechAudio', 'SREStreamEnd', 'DISPID_SWFESamplesPerSec',
    'ISpeechObjectToken', 'ISpeechPhraseElement',
    'DISPID_SRCCreateGrammar', 'SAFTGSM610_22kHzMono',
    'SRERecognition', 'DISPID_SRGCmdLoadFromResource',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRSTs_NewEnum',
    'SpeechRecognitionType', 'SPBO_AHEAD', 'DISPID_SpeechAudio',
    'SRAONone', 'DISPID_SDKSetBinaryValue', 'DISPID_SLPSymbolic',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIEnginePrivateData',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIElements',
    'SP_VISEME_15', 'SpeechEmulationCompareFlags',
    'eLEXTYPE_PRIVATE17', 'SVSFIsFilename',
    'ISpeechTextSelectionInformation', 'SpSharedRecognizer',
    'DISPID_SpeechWaveFormatEx', 'SPEI_START_INPUT_STREAM',
    'DISPID_SABIMinNotification', 'ISpeechLexiconPronunciation',
    'SpPhoneConverter', 'SP_VISEME_2', 'SVP_10', 'DISPID_SRRTLength',
    'ISpeechPhraseInfo', 'DISPID_SVEVoiceChange', 'SpObjectToken',
    'SpeechPropertyHighConfidenceThreshold', 'SPEI_END_SR_STREAM',
    'SPEI_MAX_SR', 'DISPID_SVSkip', 'SWTDeleted', 'DISPID_SMSSetData',
    'SVF_None', 'SPDKL_LocalMachine', 'SDTAlternates',
    'SpPhraseInfoBuilder', 'SREAllEvents', 'DISPID_SVGetAudioInputs',
    'eWORDTYPE_ADDED', 'DISPID_SWFEBitsPerSample', 'SDTProperty',
    'eLEXTYPE_PRIVATE15', 'SVSFUnusedFlags',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpCompressedLexicon',
    'SPEI_MIN_TTS', 'ISpeechRecoResultTimes',
    'DISPID_SpeechMMSysAudio', 'SPRECORESULTTIMES', 'tagSTATSTG',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRGCmdSetRuleIdState',
    'ISpNotifySource', 'SPFM_OPEN_READONLY', 'DISPID_SDKCreateKey',
    'SPEI_RESERVED2', 'DISPID_SDKEnumKeys', 'DISPID_SVDisplayUI',
    'SPPROPERTYINFO', 'DISPID_SRGCmdSetRuleState', 'DISPID_SOTSetId',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SABufferInfo',
    'SPSTREAMFORMATTYPE', 'ISpeechAudioFormat',
    'DISPID_SpeechRecoResult2', 'STCLocalServer',
    'DISPID_SpeechLexiconWord', 'DISPID_SRCERequestUI', 'SPAR_Low',
    'DISPID_SGRSAddSpecialTransition', 'SpeechCategoryAudioOut',
    'SpMMAudioIn', 'SGDSInactive', 'SPBO_TIME_UNITS',
    'SPDKL_CurrentConfig', 'SGDSActive', 'SPCATEGORYTYPE',
    'Speech_Max_Pron_Length', 'DISPID_SPPParent',
    'DISPID_SPCPhoneToId', 'ISpeechFileStream',
    'DISPID_SpeechPhraseRule', 'DISPID_SRGState', 'SVP_14',
    'SGLexical', 'IInternetSecurityMgrSite',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSSuppressWord',
    'SAFTADPCM_44kHzMono', 'SITooLoud', 'Speech_StreamPos_Asap',
    'DISPID_SAEventHandle', 'DISPID_SPRulesItem', 'SAFT48kHz8BitMono',
    'SSTTWildcard', 'SPEI_RECOGNITION', 'DISPID_SOTs_NewEnum',
    'SPSHORTCUTPAIRLIST', 'SVF_Stressed', 'DISPID_SGRId',
    'SSFMOpenForRead', 'DISPID_SPRuleChildren', 'SVEWordBoundary',
    'SVP_1', 'SITooFast', 'SPCS_DISABLED', 'DISPID_SPEsItem',
    'SpWaveFormatEx', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPIEngineId', 'SINoSignal', 'SPSLMA', 'SDKLCurrentUser',
    'DISPID_SOTCEnumerateTokens', 'SBOPause', 'DISPID_SRCEBookmark',
    'SDA_No_Trailing_Space', 'DISPID_SGRSTRule', 'SDTReplacement',
    'SPSEMANTICFORMAT', 'ISpPhraseAlt', 'SGRSTTTextBuffer',
    'DISPID_SVEBookmark', 'SVP_12', 'SPRST_INACTIVE_WITH_PURGE',
    'SRCS_Enabled', 'eLEXTYPE_PRIVATE16', 'DISPIDSPTSI_ActiveLength',
    'SRSInactiveWithPurge', 'SPGS_ENABLED', 'SPEVENTSOURCEINFO',
    'ISpeechPhraseRule', 'DISPID_SRCERecognition', 'SPEI_SOUND_END',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIGetText',
    'DISPID_SVSpeakCompleteEvent', 'SLODynamic',
    'DISPID_SpeechPhoneConverter', 'SRERequestUI',
    'DISPID_SpeechPhraseAlternates', 'SpeechPropertyAdaptationOn',
    'STSF_LocalAppData', '_SPAUDIOSTATE', 'SPPS_Verb',
    'SpeechVisemeFeature', 'ISpeechLexiconWord', 'SpLexicon',
    'SP_VISEME_16', 'SpVoice', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCRetainedAudio', 'SGSExclusive', 'SRAInterpreter',
    'DISPID_SMSADeviceId', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechVoiceStatus', 'SpeechDictationTopicSpelling',
    'SPAO_NONE', 'SPRECOGNIZERSTATUS', 'DISPID_SRRAudioFormat',
    'ISpLexicon', 'ISpeechAudioStatus', 'SAFT8kHz8BitMono',
    'SSFMCreateForWrite', 'DISPID_SLGetPronunciations',
    'SPWT_DISPLAY', 'SAFT32kHz8BitStereo', 'SVP_17',
    'DISPID_SRCEAdaptation', 'SPEI_END_INPUT_STREAM',
    'DISPID_SFSClose', 'DISPID_SPRFirstElement',
    'DISPID_SWFEExtraData', 'SVP_11', 'SpAudioFormat',
    'SpeechInterference', 'SPBINARYGRAMMAR',
    'ISpeechPhraseReplacement', 'SpeechGrammarWordType',
    'SPSHT_EMAIL', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SpeechLexicon', 'DISPID_SVAudioOutput', 'SLTUser',
    'tagSPTEXTSELECTIONINFO', 'SPEVENT',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCEventInterests',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SDA_One_Trailing_Space',
    'DISPID_SPPEngineConfidence', 'eLEXTYPE_PRIVATE4',
    'SECLowConfidence', 'SpStream', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechObjectTokenCategory', 'SRESoundStart',
    'SPEI_RESERVED3', 'DISPID_SRCERecognitionForOtherContext',
    'SAFT12kHz16BitStereo', 'eLEXTYPE_PRIVATE19', 'SpeechDiscardType',
    'SPFM_NUM_MODES', 'SpeechRuleAttributes', 'ISpAudio',
    'DISPID_SGRsFindRule', 'DISPID_SGRsAdd',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechGrammarRules',
    'ISpRecoContext2', 'SpNullPhoneConverter', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_5', 'SAFTText',
    'SPAS_STOP', 'DISPID_SPEAudioSizeBytes',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPPHRASEPROPERTY',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechCustomStream',
    'DISPID_SRRAudio', 'DISPID_SLPType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPCT_SUB_DICTATION',
    'SAFT32kHz16BitMono', 'SAFT22kHz16BitMono',
    'DISPID_SRCERecognizerStateChange', 'SpeechAudioFormatGUIDWave',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_uLaw_22kHzMono',
    'SLTApp', 'SpeechVoiceSpeakFlags', 'eLEXTYPE_PRIVATE12',
    'DISPID_SGRSTWeight', 'SpeechGrammarTagUnlimitedDictation',
    'SVEPhoneme', 'ISpeechObjectTokens', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRESoundEnd', 'DISPID_SVResume', 'DISPID_SGRsDynamic',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_19', 'SPSModifier',
    'DISPID_SRCEInterference', 'DISPID_SVVoice',
    'eLEXTYPE_LETTERTOSOUND', '__MIDL_IWinTypes_0009',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SFTSREngine',
    'DISPID_SLPPhoneIds', 'SPSFunction', 'SPWORDLIST',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVSLastResult',
    'SGLexicalNoSpecialChars', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechPhraseReplacement',
    'DISPID_SPIGetDisplayAttributes', 'SpeechCategoryRecognizers',
    'DISPID_SLAddPronunciation', 'SPRST_ACTIVE', 'ISpeechVoice',
    'SRSEIsSpeaking', 'DISPID_SPAsCount', 'SPLO_STATIC',
    'eLEXTYPE_PRIVATE20', 'SpeechRunState', 'SDKLDefaultLocation',
    'DISPID_SVSpeakStream', 'SPWORD', 'DISPID_SDKSetStringValue',
    'SP_VISEME_18', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPCIdToPhone', 'DISPID_SOTsCount',
    'SpeechRegistryUserRoot', 'ISpeechRecognizer',
    'DISPID_SPAs_NewEnum', 'SpeechTokenShellFolder',
    'DISPID_SCSBaseStream', 'SpTextSelectionInformation',
    'SAFT8kHz16BitStereo', 'SPRST_INACTIVE', 'WAVEFORMATEX',
    'DISPID_SpeechRecognizer', 'ISpeechResourceLoader',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPRs_NewEnum',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechRecoContext',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRGReset',
    'SAFT32kHz8BitMono', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT22kHz16BitStereo', 'DISPIDSPTSI_ActiveOffset',
    'SpeechPropertyLowConfidenceThreshold',
    'SAFTCCITT_uLaw_11kHzStereo', 'SECNormalConfidence',
    'SPEI_TTS_BOOKMARK', 'SASRun', 'DISPID_SWFEBlockAlign', 'SDTAll',
    'SpeechVoiceSkipTypeSentence', 'SVP_2', 'SECFNoSpecialChars',
    'SVSFPersistXML', 'LONG_PTR', 'SPRS_INACTIVE',
    'SAFT11kHz16BitStereo', 'SAFT12kHz8BitStereo', 'SVSFParseSsml',
    'SpNotifyTranslator', 'ISpeechDataKey', 'SpeechUserTraining',
    'DISPID_SVSPhonemeId', 'SASClosed', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCVoice',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechBaseStream', 'DISPID_SLWWord',
    'SWPKnownWordPronounceable', 'SP_VISEME_9', 'SPWORDTYPE',
    'ISpeechRecoResultDispatch', 'SPPS_RESERVED2',
    'DISPID_SGRSTsItem', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SVEViseme', 'SpeechAddRemoveWord', 'SpeechGrammarTagWildcard',
    'ISpeechPhraseInfoBuilder', 'ISpeechCustomStream',
    'SVSFParseMask', 'eLEXTYPE_PRIVATE6',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSTType',
    'DISPID_SPPConfidence', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SGRInitialState', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE13', 'SpeechTokenKeyAttributes',
    'DISPID_SPAPhraseInfo', 'SAFT11kHz8BitStereo',
    'SAFT32kHz16BitStereo', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFT24kHz8BitMono', 'SPAUDIOOPTIONS',
    'DISPID_SRSSupportedLanguages', 'SVSFVoiceMask', 'SP_VISEME_0',
    'ISpeechMemoryStream', 'SFTInput', 'SGSEnabled', 'SPCT_SLEEP',
    'ISpeechLexicon', 'DISPID_SABIBufferSize', 'SVEEndInputStream',
    'SITooQuiet', 'SPRULESTATE', 'eLEXTYPE_PRIVATE2',
    'SpeechAudioFormatType', 'DISPID_SREmulateRecognition',
    'SRAORetainAudio', 'DISPID_SPEPronunciation', 'SRAExport',
    'DISPID_SRIsShared', 'SP_VISEME_10', 'SPPHRASERULE',
    'DISPID_SPAsItem', 'DISPID_SpeechPhraseElement',
    'DISPID_SRAudioInput', 'SpeechAudioProperties',
    'DISPID_SRAudioInputStream', 'DISPID_SLPLangId',
    'SpeechMicTraining', 'SGDisplay', 'SSSPTRelativeToEnd',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPRulesCount',
    'SPPS_Interjection', 'SPVPRI_ALERT', 'DISPID_SVVolume', 'SVPOver',
    'SREFalseRecognition', 'DISPID_SRGetFormat', 'SPFILEMODE',
    'ISpeechGrammarRules', 'SPSUnknown', 'DISPID_SLPsItem', 'SVP_8',
    'DISPID_SMSAMMHandle', 'SpeechVoiceCategoryTTSRate',
    'SPEI_START_SR_STREAM', 'DISPID_SRGetPropertyString',
    'SPRECOSTATE', 'SpeechAudioFormatGUIDText', 'SPSMF_UPS',
    'SDTPronunciation', 'SSFMOpenReadWrite', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVSLastBookmark', 'SVESentenceBoundary', 'DISPID_SAFGuid',
    'DISPID_SRSClsidEngine', 'DISPID_SPRuleId',
    'SREPropertyNumChange', 'DISPID_SpeechBaseStream',
    'SpMMAudioEnum', 'SRSActive', 'DISPID_SGRAttributes',
    'SDKLCurrentConfig', 'DISPID_SADefaultFormat',
    'DISPID_SVEAudioLevel', 'ISpNotifySink', 'SPDATAKEYLOCATION',
    'SSFMCreate', 'ISpEventSink', 'SAFT12kHz16BitMono',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechStreamFileMode',
    'SPCT_SUB_COMMAND', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechRecoProfileProperties', 'DISPID_SVRate',
    'SPEI_PHRASE_START', 'SPPS_RESERVED1', 'SGRSTTDictation',
    '_RemotableHandle', 'SPEI_PHONEME', 'SAFT44kHz16BitStereo',
    'DISPID_SOTsItem', 'DISPID_SDKGetlongValue', 'SREAdaptation',
    'SAFT22kHz8BitMono', 'SP_VISEME_3', 'DISPID_SVSRunningState',
    'ISpeechAudioBufferInfo', 'SVP_7', 'DISPID_SpeechPhraseProperty',
    'DISPID_SLGetWords', 'SAFT12kHz8BitMono', 'DISPID_SPIGrammarId',
    'SVSFParseSapi', 'SVP_15', 'SPEI_MIN_SR',
    ...
    'DISPID_SPEsCount', 'SVSFNLPMask', 'DISPID_SRCResume', 'SPSVerb',
    'SpeechBookmarkOptions', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPRNumberOfElements',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_RESERVED4', 'SPAS_CLOSED', 'DISPID_SpeechPhraseInfo',
    'SECFIgnoreWidth', 'SPBO_PAUSE', 'SpeechTokenContext',
    'SECFIgnoreCase', 'DISPID_SRCCmdMaxAlternates',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechRecoResult',
    'ISpDataKey', 'SPPS_LMA', 'SVSFDefault', 'SPEI_INTERFERENCE',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCEPhraseStart',
    '_ISpeechVoiceEvents', 'ISpEventSource', 'SVPNormal',
    'DISPID_SDKGetBinaryValue', 'SAFTADPCM_11kHzStereo',
    'eLEXTYPE_PRIVATE5', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRRecognizer', 'SRAImport', 'SPBOOKMARKOPTIONS',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SAFType',
    'DISPID_SASFreeBufferSpace', 'DISPID_SWFEChannels',
    'SpMemoryStream', 'SPAUDIOBUFFERINFO', 'SAFTNoAssignedFormat',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_VOICE_CHANGE', 'STCAll', 'ISpPhoneConverter',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechRecoContext',
    'SPPS_RESERVED3', 'DISPID_SGRSRule', 'SRSInactive',
    'DISPID_SGRAddResource', 'SPCT_DICTATION', 'SREPrivate',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechGrammarRuleState',
    'SP_VISEME_8', 'SVP_19', 'SP_VISEME_17',
    'DISPID_SASNonBlockingIO', 'DISPID_SRStatus',
    'DISPID_SpeechDataKey', 'DISPID_SAVolume',
    'DISPID_SRCEHypothesis', 'DISPID_SLWsItem', 'SpeechPartOfSpeech',
    'DISPID_SLWLangId', 'DISPID_SGRName', 'tagSPPROPERTYINFO',
    'SPPS_Modifier', 'SAFT24kHz16BitMono', 'SP_VISEME_13',
    'SpeechAllElements', 'DISPID_SRCEEnginePrivate',
    'SRSActiveAlways', 'SVSFPurgeBeforeSpeak', 'SLOStatic',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SBSFormat',
    'DISPID_SVSInputWordPosition', 'SPTEXTSELECTIONINFO',
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechMemoryStream',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVEStartInputStream', 'SAFTCCITT_uLaw_11kHzMono',
    'SpObjectTokenCategory', 'SPFM_CREATE', 'SAFT44kHz8BitMono',
    'DISPID_SVEStreamStart', 'SPVISEMES', 'SRTReSent', 'DISPIDSPRG',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTId', 'DISPID_SOTCDefault',
    'DISPID_SPEActualConfidence', 'SPFM_OPEN_READWRITE',
    'SpeechAudioState', 'DISPID_SPILanguageId',
    'SpeechRecognizerState', 'DISPID_SVSVisemeId',
    'SPSERIALIZEDRESULT', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVIsUISupported', 'SRSEDone',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVEEnginePrivate',
    'IStream', 'DISPID_SRGDictationUnload',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPELexicalForm', 'DISPID_SLGetGenerationChange',
    'DISPID_SLWs_NewEnum', 'DISPID_SPRules_NewEnum', 'SECFDefault',
    'SAFT8kHz8BitStereo', 'SAFT48kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPAUDIOSTATE',
    'SAFTADPCM_8kHzMono', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPEEngineConfidence', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCESoundStart', 'SP_VISEME_6',
    'DISPID_SRGIsPronounceable', 'SRERecoOtherContext',
    'SPCONTEXTSTATE', 'DISPID_SPPFirstElement', 'SGRSTTWord',
    'SAFT24kHz8BitStereo', 'SPINTERFERENCE_TOOQUIET', 'STSF_AppData',
    'SPXRO_Alternates_SML', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechVoice', 'DISPID_SPERequiredConfidence',
    'STCRemoteServer', 'SPRECOCONTEXTSTATUS', 'SWTAdded',
    'DISPID_SASState', 'DISPID_SRGDictationSetState',
    'SpeechTokenIdUserLexicon', 'DISPID_SLRemovePronunciation',
    'SECFEmulateResult', 'DISPID_SRRTimes', 'SPGRAMMARSTATE',
    'SDTAudio', 'ISpMMSysAudio', 'DISPID_SVPriority', 'SITooSlow',
    'DISPID_SPPsCount', 'SPEVENTENUM', 'ISpeechRecoResult',
    'SRTAutopause', 'DISPID_SRDisplayUI', 'SP_VISEME_7', 'SPBO_NONE',
    'ISpeechPhraseReplacements', 'DISPID_SpeechRecognizerStatus',
    'SpeechVoiceEvents', 'SASPause', 'IEnumSpObjectTokens',
    'DISPID_SPACommit', 'DISPID_SOTDataKey', 'SPAR_High',
    'SDA_Consume_Leading_Spaces', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpRecognizer3', 'ISpeechRecoGrammar', 'DISPID_SPIReplacements',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_SENTENCE_BOUNDARY',
    'SPWORDPRONOUNCEABLE', 'SGDSActiveUserDelimited',
    'DISPID_SPRsItem', 'SPGS_DISABLED',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEPropertyStringChange', 'eWORDTYPE_DELETED',
    'SP_VISEME_4', 'SpeechRecoEvents', 'DISPID_SGRSTPropertyName',
    'SAFT16kHz16BitMono', 'SpeechEngineConfidence',
    'DISPID_SASetState', 'SDTRule', 'SP_VISEME_1',
    'DISPID_SRRSetTextFeedback', 'DISPID_SBSWrite', 'SVP_18',
    'DISPID_SOTGetAttribute', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechRecognizerStatus', 'SRCS_Disabled',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SDKOpenKey', 'SGPronounciation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRIsUISupported',
    'SBONone', 'SDTLexicalForm', 'DISPID_SRGRecoContext',
    'SGDSActiveWithAutoPause', 'SVEPrivate', 'SpeechAudioVolume',
    'DISPID_SRGetRecognizers', 'DISPID_SVEventInterests',
    'SpeechLexiconType', 'eLEXTYPE_MORPHOLOGY',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCAudioInInterferenceStatus',
    'SRTStandard', 'DISPID_SRRSpeakAudio',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE3',
    'DISPID_SGRsItem', 'eLEXTYPE_RESERVED7', 'SPSHORTCUTTYPE',
    'eLEXTYPE_USER', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechRecoContextState', 'SRTEmulated',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRRRecoContext',
    'DISPID_SOTCreateInstance', 'DISPID_SRCPause',
    'ISpeechLexiconWords', 'SP_VISEME_12', 'SAFT11kHz8BitMono',
    'ISpObjectToken', 'SPEI_HYPOTHESIS', 'SpeechTokenKeyFiles',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechPhraseElements',
    'ISequentialStream', 'ISpStream', 'SREPropertyStringChange',
    'DISPID_SLWPronunciations', 'SpStreamFormatConverter',
    'SVSFIsXML', 'DISPID_SRGRules', 'SPDKL_CurrentUser',
    'SRTExtendableParse', 'DISPID_SVEViseme', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SVGetVoices', 'SpeechRetainedAudioOptions',
    'SpeechDisplayAttributes', 'SAFT24kHz16BitStereo',
    'DISPID_SGRSTPropertyId', 'SPLOADOPTIONS', 'DISPID_SAStatus',
    'SVP_20', 'SPAR_Unknown', 'SINone', 'SPEI_SR_AUDIO_LEVEL',
    'UINT_PTR', 'ISpXMLRecoResult', 'DISPID_SpeechAudioStatus',
    'SPEI_UNDEFINED', 'DISPID_SDKDeleteValue', 'eLEXTYPE_RESERVED10',
    'SVEVoiceChange', 'DISPID_SRCVoicePurgeEvent', 'SpeechVisemeType',
    'DISPID_SGRAddState', 'SPPS_SuppressWord', 'SPWT_PRONUNCIATION',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSInputSentenceLength', 'DISPID_SOTCategory',
    'SPINTERFERENCE_NONE', 'DISPID_SGRsCommit', 'SGRSTTRule',
    'DISPID_SPEs_NewEnum', 'SVP_16', 'SRATopLevel',
    'SAFT48kHz8BitStereo', 'SPAO_RETAIN_AUDIO',
    'ISpPhoneticAlphabetSelection', 'SPGS_EXCLUSIVE',
    'SAFT16kHz16BitStereo', 'DISPID_SOTMatchesAttributes', 'ISpVoice',
    'SDTDisplayText', 'DISPID_SRCState', 'DISPID_SVAudioOutputStream',
    'SREStateChange', 'SpeechLoadOption',
    'ISpPhoneticAlphabetConverter', 'ISpeechPhraseProperty',
    'DISPID_SRRSaveToMemory', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVSInputSentencePosition',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRCEStartStream',
    'eLEXTYPE_USER_SHORTCUT', 'SRADefaultToActive', 'SGRSTTEpsilon',
    'SPPS_Unknown', 'DISPID_SPIRetainedSizeBytes',
    'SpeechCategoryAudioIn', 'DISPID_SRGCommit', 'SGSDisabled',
    'DISPID_SABufferNotifySize', 'DISPID_SGRs_NewEnum',
    'SPVOICESTATUS', 'SpResourceManager', 'SPDKL_DefaultLocation',
    'STSF_FlagCreate', 'SPLO_DYNAMIC', 'DISPID_SVWaitUntilDone',
    'DISPID_SAFSetWaveFormatEx', 'SpeechTokenValueCLSID',
    'SPRS_ACTIVE', 'eLEXTYPE_PRIVATE7', 'DISPID_SPPChildren',
    'SPSHT_NotOverriden', 'DISPID_SPRText', 'SpeechCategoryVoices',
    'SpeechStreamSeekPositionType', 'SpeechGrammarTagDictation',
    'DISPID_SpeechPhraseRules', 'SPEI_RESERVED5',
    'DISPID_SDKDeleteKey', 'Speech_Max_Word_Length',
    'DISPID_SABIEventBias', 'SPPS_Noncontent', 'SAFT16kHz8BitStereo',
    'SVEBookmark', 'DISPID_SPPName', 'DISPID_SPRuleEngineConfidence',
    'SPAR_Medium', 'DISPID_SASCurrentSeekPosition', 'SPSNoun',
    'SPWORDPRONUNCIATION', 'SRTSMLTimeout',
    'SpeechPropertyResponseSpeed', 'SPEI_REQUEST_UI',
    'DISPID_SGRsCommitAndSave', 'SpeechCategoryAppLexicons',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_RESERVED1',
    'SPGRAMMARWORDTYPE', 'DISPID_SPIAudioStreamPosition',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPEAudioStreamOffset',
    'SpFileStream', 'SP_VISEME_20', 'DISPID_SOTRemoveStorageFileName',
    'ISpeechGrammarRuleState', 'SDA_Two_Trailing_Spaces',
    'SPPHRASEREPLACEMENT', 'DISPID_SGRSTransitions',
    'SAFTADPCM_11kHzMono', 'DISPID_SMSALineId', 'SSTTDictation',
    'DISPID_SpeechRecoResultTimes', 'STCInprocHandler',
    'ISpeechObjectTokenCategory', 'eLEXTYPE_RESERVED6',
    'eLEXTYPE_PRIVATE11', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'eLEXTYPE_PRIVATE14', 'SPWF_INPUT', 'DISPID_SGRClear',
    'SAFTADPCM_22kHzStereo', 'SPPHRASE', 'DISPID_SRSetPropertyNumber',
    'SpeechVoicePriority', 'DISPID_SVStatus', 'DISPID_SGRSTNextState',
    'DISPID_SOTCSetId', 'DISPID_SPANumberOfElementsInResult',
    'ISpRecoContext', 'STSF_CommonAppData', 'ISpResourceManager',
    'SECFIgnoreKanaType', 'SPEI_ADAPTATION', 'SpInprocRecognizer',
    'DISPID_SPIRule', 'DISPID_SRCRecognizer', 'DISPID_SVPause',
    'ISpRecognizer', 'SPINTERFERENCE', 'DISPID_SRRPhraseInfo',
    'ISpRecognizer2', 'SRARoot', 'SpeechWordPronounceable',
    'DISPID_SOTGetDescription', 'SAFTNonStandardFormat',
    'Speech_Default_Weight', 'SVSFIsNotXML',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRRGetXMLResult',
    'DISPID_SRRAlternates', 'SPEI_RESERVED6', 'SPPS_Noun',
    'ISpeechPhraseAlternates', 'DISPID_SPPValue',
    'DISPID_SPRuleParent', 'ISpStreamFormat', 'SAFT16kHz8BitMono',
    'DISPID_SpeechLexiconProns', 'SPSHT_Unknown',
    'ISpObjectWithToken', 'eLEXTYPE_RESERVED9', 'eLEXTYPE_RESERVED8',
    'SREHypothesis', 'DISPID_SVEStreamEnd', 'SPVPRI_NORMAL',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_21',
    'DISPID_SVGetProfiles', 'SPEI_SR_PRIVATE', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_APP', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRSCurrentStreamNumber',
    'ISpeechGrammarRuleStateTransition', 'SAFTDefault', 'SPAS_RUN',
    'SDKLLocalMachine', 'DISPID_SRCEEndStream',
    'SAFTGSM610_11kHzMono', 'DISPID_SLWType', 'SVP_21',
    'SREStreamStart', 'DISPID_SpeechObjectToken', 'SVF_Emphasis',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPIStartTime',
    ...
    'ISpNotifyTranslator', 'SPPS_Function', 'DISPID_SLGenerationId',
    'SPEI_SOUND_START', 'ISpProperties', 'ISpStreamFormatConverter',
    'SPEI_SR_BOOKMARK', 'DISPID_SOTIsUISupported', 'SpMMAudioOut',
    'SAFTGSM610_44kHzMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechObjectTokens', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRState', 'SpCustomStream', 'DISPID_SGRsCount',
    'SPAS_PAUSE', 'SPXRO_SML', 'SWPUnknownWordPronounceable',
    ...
    'SPSInterjection', 'ISpeechPhraseRules', 'SPPARTOFSPEECH',
    'ISpPhrase', '_ISpeechRecoContextEvents',
    'DISPID_SDKGetStringValue', 'DISPID_SOTGetStorageFileName',
    'SpeechRuleState', 'SPVPRIORITY', 'SREBookmark',
    'DISPID_SRGSetWordSequenceData',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVSFlagsAsync',
    'DISPID_SDKSetLongValue', 'DISPID_SOTRemove', 'SPSHORTCUTPAIR',
    'DISPID_SpeechPhraseElements', 'SpeechSpecialTransitionType',
    'SPVPRI_OVER', 'DISPID_SPRDisplayAttributes',
    ...
    'SPINTERFERENCE_NOISE', 'DISPID_SLWsCount', 'SPSNotOverriden',
    'ISpRecoGrammar2', 'SpeechTokenKeyUI', 'ISpeechVoiceStatus',
    'DISPID_SRSetPropertyString', 'SpeechDataKeyLocation',
    'DISPID_SPAStartElementInResult', 'DISPID_SDKEnumValues',
    'SPWT_LEXICAL', 'DISPID_SPEDisplayText', 'SREPhraseStart',
    'ISpGrammarBuilder', 'DISPID_SVSpeak', 'DISPID_SLPsCount',
    'SAFTGSM610_8kHzMono', 'SPSMF_SAPI_PROPERTIES',
    'SECHighConfidence', 'ISpeechWaveFormatEx', 'DISPID_SOTCId',
    'SAFTCCITT_uLaw_44kHzMono', 'SPPS_RESERVED4'
]

_check_version('1.2.0', 1614803100.064516)
